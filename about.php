...
<body>
      ...
      <div class="about">
        ...
        <div class="about-title">OUR CORE BELIEFS</div>

        <div class="about-image">
          <img src="images/handticket.png">
        </div>

      <div class="about-body">
     <h3>       </h3>
      <p>  Our mission is to make route optimization software accessible to everyone.</p>
     ...
     <div class="core-value-items-title">  
        <h3>MyTicket's Core Values</h3> 
        </div>
        <div class="core-value-items">
